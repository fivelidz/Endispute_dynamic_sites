...
/**
 * The range of processes — Facilitative → Advisory → Determinative continuum.
 * Replaces the static "The-Endispute-range-of-processes" diagram image with a
 * structured, responsive, accessible matrix. Each mode lists its defining
 * CHARACTERISTICS and the example PROCESSES that live within it.
 */
