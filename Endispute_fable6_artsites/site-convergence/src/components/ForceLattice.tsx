...
// Recoloured to match the "Verdict" obsidian + single-signal-red scheme:
// left side = cool ash/white (one party), right side = signal red (the other),
// bridging agreement lines = a bright rose between them.
const TEAL = { r: 0xe6, g: 0xe6, b: 0xee };   // ash-white party
const AMBER = { r: 0xfc, g: 0x1c, b: 0x46 };  // signal-red party
const INDIGO = { r: 0xff, g: 0x5a, b: 0x78 }; // rose bridge (the resolution)
