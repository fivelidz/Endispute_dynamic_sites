...
export const faqs = [
  ...
  },
  {
    ...
    a: "Endispute operates around Australia and internationally. We arrange meeting venues throughout Australia and through our international network of providers. Please send us a message and we will respond promptly and in confidence.",
  },
  {
...
// The "range of processes" spectrum matrix — transcribed from Endispute's
// original process diagram. Each mode lists its defining characteristics and
// the example processes that sit within it. Used by the SpectrumMatrix graphic.
export const processSpectrum = [
  {
    mode: "Facilitative",
    blurb: "A third party assists the parties to run their own resolution.",
    characteristics: [
      "Informal",
      "Flexible",
    ...
    examples: ["Negotiation", "Facilitation", "Conferencing", "Mediation", "Partnering"],
  },
  {
    mode: "Advisory",
    blurb: "A third party investigates and advises on the likely outcome.",
    characteristics: ["Guidelines and rules", "Limited document exchange", "Confidential"],
    examples: [
  ...
  {
    mode: "Determinative",
    blurb: "A third party hears the matter and makes a binding determination.",
    characteristics: [
      "Formal",
    ...
    examples: ["Expert determination", "Independent fact-finding", "Mini-trial", "Arbitration"],
  },
] as const;
